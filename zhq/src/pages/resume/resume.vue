<template>
  <view class="resume-container">
    ...
    <view class="resume-list">
      <view class="resume-item" v-for="(item, index) in resumeList" :key="index">
    ...
    <view class="upload-section">
      ...
      <view class="section-tip">建议选用使用PDF文件,支持doc,docx,jpg,png格式,大小不超过20M</view>
...
export default {
  ...
  methods: {
    ...
    handleUpload(file) {
      ...
      // 上传文件到服务器
      uni.uploadFile({
        url: 'your-upload-api-url', // 替换为你的上传接口
